...
public class HandlebarsHydratorTest {
    ...
    private static final String VALID_CHILD_TABLE_CLASS = "/*\n"
            ...
            + "\n"
            + "\n"
            + "    protected com.yahoo.elide.datastores.aggregation.timegrains.WeekDateISO createdWeekDate;\n"
            + "\n"
            + "\n"
            + "\n"
            + "\n"
            + "    @Temporal(grain = @TimeGrainDefinition(grain = TimeGrain.WEEKDATEISO, expression = \"PARSEDATETIME(FORMATDATETIME({{}}, 'yyyy-MM-dd'), 'yyyy-MM-dd')\"), timeZone = \"UTC\")\n"
            + "\n"
            + "\n"
            + "    @ReadPermission(expression = \"Prefab.Role.All\")\n"
            + "    @ColumnMeta(\n"
            ...
            + "\n"
            + "    public com.yahoo.elide.datastores.aggregation.timegrains.WeekDateISO getCreatedWeekDate() {\n"
            + "        return createdWeekDate;\n"
            + "    }\n"
            + "\n"
            + "    public void setCreatedWeekDate(com.yahoo.elide.datastores.aggregation.timegrains.WeekDateISO createdWeekDate) {\n"
