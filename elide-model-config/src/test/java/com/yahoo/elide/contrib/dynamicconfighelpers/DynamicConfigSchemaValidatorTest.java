...
public class DynamicConfigSchemaValidatorTest {
    ...
    public void testInvalidTableSchemaMultipleErrors(String resource) throws Exception {
        ...
        String expectedMessage = "Schema validation failed for: table_schema_with_multiple_errors.hjson\n"
                        ...
                        + "    Instance[/tables/0/dimensions/0] failed to validate against schema[/definitions/timeDimension]. Properties: [tableSource] are not allowed for dimensions.\n"
                        + "[ERROR]\n"
                        ...
                        + "    Instance[/tables/0/dimensions/1] failed to validate against schema[/definitions/timeDimension]. Properties: [values, tableSource] are not allowed for dimensions.\n"
                        + "[ERROR]\n"
                        ...
                        + "    Instance[/tables/0/dimensions/2] failed to validate against schema[/definitions/dimension]. Properties: [grain] are not allowed for dimensions.\n"
