...
public class HandlebarsHydratorTest {
    ...
    private static final String VALID_CHILD_TABLE_CLASS = "/*\n"
            ...
            + "\n"
            + "\n"
            + "    @Temporal(grain = @TimeGrainDefinition(grain = TimeGrain.MONTH, expression = \"PARSEDATETIME(FORMATDATETIME(${column}, 'yyyy-MM-dd'), 'yyyy-MM-dd')\"), timeZone = \"UTC\")\n"
            + "\n"
            + "\n"
            + "    @ReadPermission(expression = \"Prefab.Role.All\")\n"
            + "    @ColumnMeta(\n"
            ...
            + "    @DimensionFormula(\"{{create_on}}\")\n"
            + "\n"
            + "    public com.yahoo.elide.datastores.aggregation.timegrains.Month getCreatedOn() {\n"
            + "        return (com.yahoo.elide.datastores.aggregation.timegrains.Month) createdOn;\n"
            + "    }\n"
            + "\n"
            + "    public void setCreatedOn(com.yahoo.elide.datastores.aggregation.timegrains.Month createdOn) {\n"
            + "        this.createdOn = createdOn;\n"
            + "    }\n"
            + "\n"
            + "\n"
