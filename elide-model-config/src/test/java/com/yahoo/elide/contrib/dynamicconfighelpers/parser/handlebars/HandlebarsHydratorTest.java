...
public class HandlebarsHydratorTest {
    ...
    @Test
    public void testTableGrainHydration() throws IOException {
        Map<String, String> tableClasses = hydrator.hydrateTableTemplate(testClass.getElideTableConfig());

        assertTrue(tableClasses.keySet().contains(VALID_TABLE_GRAIN_JAVA_NAME));
        assertEquals(VALID_TABLE_GRAIN_CLASS, tableClasses.get(VALID_TABLE_GRAIN_JAVA_NAME));
    }
