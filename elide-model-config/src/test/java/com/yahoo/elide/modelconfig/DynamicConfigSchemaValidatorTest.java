...
public class DynamicConfigSchemaValidatorTest {
    ...
    public void testInvalidTableSchemaMultipleErrors(String resource) throws Exception {
        ...
        String expectedMessage = "Schema validation failed for: table_schema_with_multiple_errors.hjson\n"
                        ...
                        + "[ERROR]\n"
                        + "Instance[/tables/0/arguments/0/type] failed to validate against schema[/definitions/argument/properties/type]. Field type [Number] is not allowed. Supported value is one of [Integer, Decimal, Money, Text, Coordinate, Boolean] or a valid Java class name.\n"
                        + "[ERROR]\n"
