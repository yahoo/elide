...
public class MetricFormulaTest {
    ...
    public void testReferenceLoop() {
        ...
        String exception1 = "Formula validation failed for: measureLoop.lowScore. Reference Loop detected.";
        String exception2 = "Formula validation failed for: measureLoop.highScore. Reference Loop detected.";
