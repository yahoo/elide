    ...
    */
    ...
    public void testNestedMetricQuery() {
        ...
        String exptectedQueryStr =
                "SELECT AVG(\"example_PlayerStats_XXX\".\"highScore\") AS \"dailyAverageScorePerPeriod\","
    ...
    public void testNestedMetricWithHavingQuery() {
        ...
        String exptectedQueryStr =
                "SELECT AVG(\"example_PlayerStats_XXX\".\"highScore\") "
                        ...
                        + "\"example_PlayerStats_XXX\".\"overallRating\", "
                        + "\"example_PlayerStats_XXX\".\"recordedDate\" "
                        + "HAVING AVG(\"example_PlayerStats_XXX\".\"highScore\") > :XXX\n";
