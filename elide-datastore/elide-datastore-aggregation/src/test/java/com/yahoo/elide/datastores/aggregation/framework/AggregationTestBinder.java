...
public class AggregationTestBinder extends AbstractBinder {
    private final AuditLogger auditLogger;
    private final ServiceLocator injector;

    public static final BillingService BILLING_SERVICE = mock(BillingService.class);

    public AggregationTestBinder(final AuditLogger auditLogger, final ServiceLocator injector) {
    ...
    protected void configure() {
        ...
        bindFactory(new Factory<Elide>() {
            ...
            public Elide provide() {
                EntityDictionary dictionary = new AggregationDictionary(TestCheckMappings.MAPPINGS, injector::inject);
