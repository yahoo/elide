...
public class DruidExplainQueryTest  extends SQLUnitTest {

    @BeforeAll
    public static void init() {
        SQLUnitTest.init(SQLDialectFactory.getDruidDialect());
    }
    ...
    */
    ...
    /*
     * This test validates that generateCountDistinctClause() is called in the DruidDialect (same as default/H2).
     */
    @Test
    ...
    public void testNestedMetricQuery() {
        ...
        String exptectedQueryStr =
                "SELECT AVG(\"com_yahoo_elide_datastores_aggregation_example_PlayerStats_XXX\".\"highScore\") "
                        ...
                        + "\"com_yahoo_elide_datastores_aggregation_example_PlayerStats\".\"overallRating\" AS \"overallRating\","
                        + "PARSEDATETIME(FORMATDATETIME(\"com_yahoo_elide_datastores_aggregation_example_PlayerStats\".\"recordedDate\", 'yyyy-MM-dd'), 'yyyy-MM-dd') AS \"recordedDate_DAY\","
