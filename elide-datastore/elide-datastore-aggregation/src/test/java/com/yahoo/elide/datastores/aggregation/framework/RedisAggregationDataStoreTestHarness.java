...
public class RedisAggregationDataStoreTestHarness extends AggregationDataStoreTestHarness {
    ...
    public DataStore getDataStore() {
        ...
        cache.registerWithKryo(example.Player.class);
        cache.registerWithKryo(example.PlayerStatsView.class);
        cache.registerWithKryo(example.PlayerStatsWithView.class);
        cache.registerWithKryo(example.VideoGame.class);
