...
public abstract class QueryEngine {
     ...
     * @param transaction
     * @param queryLogger The user specified logger
     * @param scope The request scope of the request
     * @return query results
     */
    public abstract QueryResult executeQuery(Query query, Transaction transaction);

    /**
     * Explains and Surfaces the underlying SQL query generated by {@link Query}
     * {@link Query}. Results may be taken from a cache, if configured.
     *
     * @param query The query customized for a particular persistent storage or storage client
     * @return The underlying SQL query
     */
    public abstract void explainQuery(Query query, QueryLogger queryLogger,
