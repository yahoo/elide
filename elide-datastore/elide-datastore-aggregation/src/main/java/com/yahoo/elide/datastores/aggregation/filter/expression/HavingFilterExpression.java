...
/**
 * A sub-type of {@link FilterExpression} that is evaluated in-memory on top of returned data from persistent storage.
 * <p>
 * This is a {@link java.util.function functional interface} whose functional method is
 * {@link #accept(FilterExpressionVisitor)}
 */
@FunctionalInterface
public interface HavingFilterExpression extends FilterExpression {
