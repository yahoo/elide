...
public class EntityProjectionTranslator {
    ...
    public EntityProjectionTranslator(Schema schema, EntityProjection entityProjection, EntityDictionary dictionary) {
    ...
    public Query getQuery() {
        Query query =  Query.builder()
                ...
                .build();
        QueryValidator validator = new QueryValidator(getAllFields(), query, dictionary, entityProjection.getType());
        validator.validate();
        return query;
    }
    ...
    private Set<DimensionProjection> resolveNonTimeDimensions() {
        ...
        Set<String> allColumns = getAllFields();
    ...
    /**
     * Helper method to get all fields from the {@link EntityProjection}.
