...
public class JpaDataStoreTest {
    ...
    public void verifyJPQLGeneratorRegistration() {
        ...
        JpaDataStore store = new JpaDataStore(() -> { return managerMock; }, (unused) -> { return null; }, (entityManager) -> { return; });
    ...
    public void verifyManualEntityBinding() {
        ...
        JpaDataStore store = new JpaDataStore(() -> { return managerMock; }, (unused) -> { return null; }, (entityManager) -> { return; },Test.class);
        EntityDictionary dictionary = new EntityDictionary(new HashMap<>());
        store.populateEntityDictionary(dictionary);
