...
public class UpdateOnCreateTest extends PersistenceResourceTestSetup {
    ...
    public void createPermissionCheckClassAnnotationForCreatingAnEntitySuccessCase() {
        ...
        com.yahoo.elide.core.PersistentResource<UpdateAndCreate> created = com.yahoo.elide.core.PersistentResource.createObject(UpdateAndCreate.class, userOneScope, Optional.of("1"));
    ...
    public void createPermissionCheckFieldAnnotationForCreatingAnEntitySuccessCase() {
        ...
        com.yahoo.elide.core.PersistentResource<UpdateAndCreate> created = com.yahoo.elide.core.PersistentResource.createObject(UpdateAndCreate.class, userThreeScope, Optional.of("2"));
        created.getRequestScope().getPermissionExecutor().executeCommitChecks();
    }
    ...
    public void createPermissionCheckFieldAnnotationForCreatingAnEntityFailureCase() {
        ...
        assertThrows(
                ...
                () -> com.yahoo.elide.core.PersistentResource.createObject(UpdateAndCreate.class, userFourScope, Optional.of("3")));
    }
    ...
    public void createPermissionInheritedForAttributeSuccessCase() {
        ...
        com.yahoo.elide.core.PersistentResource<UpdateAndCreate> created = com.yahoo.elide.core.PersistentResource.createObject(UpdateAndCreate.class, userOneScope, Optional.of("4"));
    ...
    public void createPermissionInheritedForAttributeFailureCase() {
        ...
        com.yahoo.elide.core.PersistentResource<UpdateAndCreate> created = com.yahoo.elide.core.PersistentResource.createObject(UpdateAndCreate.class, userThreeScope, Optional.of("5"));
    ...
    public void createPermissionOverwrittenForAttributeSuccessCase() {
        ...
        com.yahoo.elide.core.PersistentResource<UpdateAndCreate> created = com.yahoo.elide.core.PersistentResource.createObject(UpdateAndCreate.class, userThreeScope, Optional.of("6"));
        ...
        assertThrows(
                ForbiddenAccessException.class, () -> {
                    com.yahoo.elide.core.PersistentResource<UpdateAndCreate> created =
                            com.yahoo.elide.core.PersistentResource.createObject(UpdateAndCreate.class, userFourScope, Optional.of("7"));
                    created.updateAttribute("alias", "");
                }
        );
    }
    ...
    public void createPermissionInheritedForRelationSuccessCase() {
        ...
        com.yahoo.elide.core.PersistentResource<UpdateAndCreate> created = com.yahoo.elide.core.PersistentResource.createObject(UpdateAndCreate.class, userOneScope, Optional.of("8"));
        com.yahoo.elide.core.PersistentResource<Book> loadedBook = com.yahoo.elide.core.PersistentResource.loadRecord(
                EntityProjection.builder()
                        .type(Book.class)
                        .build(),
    ...
    public void createPermissionInheritedForRelationFailureCase() {
        ...
        com.yahoo.elide.core.PersistentResource<UpdateAndCreate> created = com.yahoo.elide.core.PersistentResource.createObject(UpdateAndCreate.class, userThreeScope, Optional.of("9"));
        com.yahoo.elide.core.PersistentResource<Book> loadedBook = com.yahoo.elide.core.PersistentResource.loadRecord(
                EntityProjection.builder()
                    .type(Book.class)
                    .build(),
    ...
    public void createPermissionOverwrittenForRelationSuccessCase() {
        ...
        com.yahoo.elide.core.PersistentResource<UpdateAndCreate> created = com.yahoo.elide.core.PersistentResource.createObject(UpdateAndCreate.class, userTwoScope, Optional.of("10"));
        com.yahoo.elide.core.PersistentResource<Author> loadedAuthor = com.yahoo.elide.core.PersistentResource.loadRecord(
                EntityProjection.builder()
                        .type(Author.class)
                        .build(),
    ...
    public void createPermissionOverwrittenForRelationFailureCase() {
        ...
        com.yahoo.elide.core.PersistentResource<UpdateAndCreate> created = com.yahoo.elide.core.PersistentResource.createObject(UpdateAndCreate.class, userOneScope, Optional.of("11"));
