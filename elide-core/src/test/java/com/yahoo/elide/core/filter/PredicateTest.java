...
public class PredicateTest {
    ...
    public void testParseQueryParams() throws Exception {
        ...
        queryParams.add("filter[root.collection1.field1]", "abc");
        queryParams.add("filter[root.collection1.field2]", "def");
        queryParams.add("filter[root.collection2.field1]", "ghi,jkl");
        queryParams.add("filter[root.collection3.nested1.field1][equals]", "jkl,mno");
        queryParams.add("filter[root.collection3.nested2.field2][in]", "pqr , stu");
