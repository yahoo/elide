...
@Slf4j
@Data
public abstract class AbstractAsyncQueryThread implements Callable<AsyncQueryResult> {

    protected AsyncQuery queryObj;
    protected User user;
    protected Elide elide;
    protected final QueryRunner runner;
    protected AsyncQueryDAO asyncQueryDao;
     ...
     */
    public AbstractAsyncQueryThread(AsyncQuery queryObj, User user, Elide elide, QueryRunner runner,
    ...
    protected AsyncQueryResult processQuery() throws URISyntaxException, IOException {
        ...
        AsyncQueryResult queryResultObj = new AsyncQueryResult();
