 ...
 */
public class FieldLevelParentClassIdStandardTestBinder extends AbstractBinder {
    private final AuditLogger auditLogger;

    public FieldLevelParentClassIdStandardTestBinder(final AuditLogger auditLogger) {
